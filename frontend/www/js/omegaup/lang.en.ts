...
const translations: { [key: string]: string; } = {
  U13CannotPerform: "User under 13 years can not perform this action.",
  ...
  addContestUsernameAndPassword: "If you participated in a contest and you were given a username and a password, add them here to link them to your main account.",
  ...
  arenaRunsActionsDisqualify: "Disqualify",
  ...
  contestNewFormForTeamsDesc: "If activated, the contest can only be accessed by teams instead of users or identities. The teams have to be added to a teams group.",
  ...
  contestReportUsername: "Username: %(username)",
  ...
  courseEditAddTeachingAssistantsTooltip: "Add teaching assistants using their omegaUp username",
  ...
  feedbackSuccesfullyUpdated: "The feedback has been succesfully updated.",
  ...
  frontPageFooterSponsors: "Supporters",
  ...
  homepageSponsorsSectionTitle: "Thank you to our Supporters",
  ...
  loginThroughThirdParty: "Your user was created through a third-party login (Google, Facebook, etc.). Please login using that mechanism again in order to set a password.",
  ...
  notificationCourseRequestFeedback: "The user **%(username)** has requested feedback to the assignment %(assignmentName) in the course %(courseName)",
  ...
  userAlreadyHasSelectedRole: "User already has the selected role",
  ...
  verificationEmailSuccesfully: "Your email address has been verified.",
